...
while number_input > 0:
    ...
    # let the user know the number has been added to the list and prompt user again for another input 
        number_input = int(input(print("That number has been added to a list. Please enter another number > 0 or enter 0 to stop: ")))
